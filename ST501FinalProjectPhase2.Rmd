...
# Single Stock VaR
VaR_AAPL_normal <- sapply(alpha_values, compute_var_normal, mu = mu_AAPL, sigma = sigma_AAPL)
VaR_MSFT_normal <- sapply(alpha_values, compute_var_normal, mu = mu_MSFT, sigma = sigma_MSFT)
